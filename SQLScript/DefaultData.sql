...
INSERT INTO [dbo].[Product]([Id],[Name],[Description],[Customer],[ProductFormat],[QuantityPerUnit],[UnitPrice],[Discount],[UnitsInStock],[CategoryId],[ImageAddress],[Note])VALUES(NEWID(),'Lord of the Ring - fellowship', 'LOFR e-book',								'Kevin Bookstore',	'E-Book',	1,	10,		NULL,	'True',	null,	NULL,	NULL)
INSERT INTO [dbo].[Product]([Id],[Name],[Description],[Customer],[ProductFormat],[QuantityPerUnit],[UnitPrice],[Discount],[UnitsInStock],[CategoryId],[ImageAddress],[Note])VALUES(NEWID(),'Lord of the Ring - fellowship', 'LOFR hard copy',							'Kevin Bookstore',	'InStore',	1,	10,		NULL,	'True',	null,	NULL,	NULL)
